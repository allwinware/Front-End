...
$(document).ready(function () {
	...
	/*블락싯 탭탭*/
	$(document).on("click", "#block_come", function () {
		$("#con_slider").addClass("active");
		$('.block_tab_num_b').removeClass("block_num_active");
		$('.block_tab_num_c').addClass("block_num_active");
		seatCtl.setScrollEvent();
	});

	$(document).on("click", "#block_back", function () {
		$("#con_slider").removeClass("active");
		$('.block_tab_num_c').removeClass("block_num_active");
		$('.block_tab_num_b').addClass("block_num_active");
		seatCtl.setScrollEvent();
	});
