...
//>>demos: http://jqueryui.com/widget/
    ...
    $.Widget.prototype = {
        ...
        _setOptionDisabled: function (value) {
            ...
            if (value) {
                this._removeClass(this.hoverable, null, "bid--hover");
                this._removeClass(this.focusable, null, "bid--focus");
            }
        },
        ...
        _hoverable: function (element) {
            ...
            this._on(element, {
                mouseenter: function (event) {
                    this._addClass($(event.currentTarget), null, "bid--hover");
                },
                mouseleave: function (event) {
                    this._removeClass($(event.currentTarget), null, "bid--hover");
                }
            });
        },
        ...
        _focusable: function (element) {
            ...
            this._on(element, {
                focusin: function (event) {
                    this._addClass($(event.currentTarget), null, "bid--focus");
                },
                focusout: function (event) {
                    this._removeClass($(event.currentTarget), null, "bid--focus");
                }
            });
        },
    ...
    $.each({show: "fadeIn", hide: "fadeOut"}, function (method, defaultEffect) {
        $.Widget.prototype["_" + method] = function (element, options, callback) {
            ...
            var hasOptions;
            var effectName = !options ? method : options === true || typeof options === "number" ? defaultEffect : options.effect
                || defaultEffect;
    ...
    (function () {
        ...
        $.fn.position = function (options) {
            ...
            $.each(["my", "at"], function () {
                ...
                if (pos.length === 1) {
                    pos = rhorizontal.test(pos[0]) ? pos.concat(["center"]) : rvertical.test(pos[0]) ? ["center"].concat(pos) : ["center",
                        "center"];
                }
...
//>>demos: http://jqueryui.com/menu/
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        _keydown: function (event) {
            ...
            switch (event.keyCode) {
                ...
                default:
                    ...
                    character = event.keyCode >= 96 && event.keyCode <= 105 ? (event.keyCode - 96).toString() : String.fromCharCode(
                        event.keyCode);
        ...
        refresh: function () {
            ...
            this._addClass(newSubmenus, "ui-menu",
        ...
        collapseAll: function (event, all) {
            ...
            this.timer = this._delay(function () {
                ...
                this._removeClass(currentMenu.find(".ui-state-active"), null,
                    "ui-state-active");
...
//>>demos: http://jqueryui.com/autocomplete/
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this.isMultiLine = isTextarea || !isInput && this._isContentEditable(
                this.element);
        ...
        _searchTimeout: function (event) {
            ...
            this.searching = this._delay(function () {
                ...
                var equalValues = this.term === this._value(),
                    ...
                    modifierKey = event.altKey || event.ctrlKey || event.metaKey
                        || event.shiftKey;
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.extend(Datepicker.prototype, {
        ...
        _connectDatepicker: function (target, inst) {
            ...
            input.addClass(this.markerClassName).on("keydown", this._doKeyDown).on(
        ...
        _destroyDatepicker: function (target) {
            ...
            if (nodeName === "input") {
                ...
                $target.removeClass(this.markerClassName).off("focus",
                    this._showDatepicker).off("keydown", this._doKeyDown).off(
                    "keypress", this._doKeyPress).off("keyup", this._doKeyUp);
        ...
        parseDate: function (format, value, settings) {
            ...
            var iFormat, dim, extra,
                ...
                shortYearCutoff = (typeof shortYearCutoffTemp !== "string"
                    ? shortYearCutoffTemp : new Date().getFullYear() % 100 + parseInt(shortYearCutoffTemp,
                    10)),
                ...
                getNumber = function (match) {
                    var isDoubled = lookAhead(match),
                        size = (match === "@" ? 14 : (match === "!" ? 20 : (match === "y" && isDoubled ? 4 : (match === "o" ? 3
                            : 2)))),
                    ...
                    if (literal) {
                        ...
                        switch (format.charAt(iFormat)) {
                            ...
                            case "M":
                                ...
                                break;
                            case "y":
                                output += (lookAhead("y") ? date.getFullYear() : (date.getFullYear() % 100 < 10 ? "0" : "")
        ...
        _determineDate: function (inst, date, defaultDate) {
            var offsetNumeric = function (offset) {
                ...
                === "string" ? offsetString(date) : (typeof date === "number" ? (isNaN(date) ? defaultDate
        ...
        _generateHTML: function (inst) {
            var maxDraw, prevText, prev, nextText, next, currentText, gotoDate,
                ...
                currentDate = this._daylightSavingAdjust(
                    (!inst.currentDay ? new Date(9999, 9, 9) : new Date(inst.currentYear, inst.currentMonth,
                        inst.currentDay))),
                minDate = this._getMinMaxDate(inst, "min"),
                maxDate = this._getMinMaxDate(inst, "max"),
                ...
                if (secondary || !changeYear) {
                    ...
                    determineYear = function (value) {
                        var year = (value.match(/c[+\-].*/) ? drawYear + parseInt(
                            value.substring(1), 10) : (value.match(/[+\-].*/) ? thisYear + parseInt(value, 10) : parseInt(value, 10)));
        ...
        _getFormatConfig: function (inst) {
            ...
            shortYearCutoff = (typeof shortYearCutoff !== "string" ? shortYearCutoff : new Date().getFullYear() % 100 + parseInt(
                shortYearCutoff,
                10));
            return {
    ...
    function datepicker_handleMouseover() {
        if (!$.datepicker._isDisabledDatepicker(
            datepicker_instActive.inline ? datepicker_instActive.dpDiv.parent()[0]
...
//>>demos: http://jqueryui.com/slider/
    ...
    var widgetsSlider = $.widget("awa.bidding", $.ui.mouse, {
        version: "1.12.1",
        ...
        _create: function () {
            ...
            this._addClass("bid bid--" + this.orientation);
        ...
        _createHandles: function () {
            var i, handleCount,
                ...
                existingHandles = this.element.find(".bid__handle"),
                handle = "<div tabindex='0'><span class='bid__handle-ment'>"
                    + options.ment + "</span></div>",
                handles = [];
            ...
            this._addClass(this.handles, "bid__handle", "bid__handle-default");
        ...
        _createRange: function () {
            ...
            if (options.range) {
                ...
                if (!this.range || !this.range.length) {
                    ...
                    this.range.after("<span class='bid__value bid__value-min'>MIN<em>"
                        + this._formatString(options.min) + "</em></span>");
                ...
                if (options.range === "min" || options.range === "max") {
                    this._addClass(this.range, "bid__range--" + options.range);
                }
            } else {
                if (this.range) {
                    this.range.remove();
        ...
        _mouseCapture: function (event) {
            ...
            this._addClass(closestHandle, null, "bid__handle--active");
            closestHandle.trigger("focus");

            offset = closestHandle.offset();
            mouseOverHandle = !$(event.target).parents().addBack().is(".bid__handle");
            ...
            if (!this.handles.hasClass("bid__handle--hover")) {
        ...
        _mouseStop: function (event) {
            this._removeClass(this.handles, null, "bid--active");
            this._mouseSliding = false;
        ...
        _slide: function (event, index, newVal) {
            ...
            if (this._hasMultipleValues()) {
                ...
                if (this.options.values.length === 2 && this.options.range === true) {
                    newVal = index === 0 ? Math.min(otherVal, newVal) : Math.max(otherVal,
                        newVal);
                }
        ...
        _setOption: function (key, value) {
            ...
            switch (key) {
                case "orientation":
                    this._detectOrientation();
                    this._removeClass("bid--horizontal bid--vertical")
                    ._addClass("bid--" + this.orientation);
                    this._refreshValue();
        ...
        _setOptionDisabled: function (value) {
            ...
            this._toggleClass(null, "bid--disabled", !!value);
        },
        ...
        _trimAlignValue: function (val) {
            ...
            var remainValue = (this.options.max - this.options.min) % step;
            ...
            if (this.options.maxSelectable) {
                if (alignValue >= this._valueMax() && remainValue > 0 && remainValue
                    < step) {
                    step = remainValue;
        ...
        _numberWithCommas: function (number) {
            var parts = number.toString().split(".");
            parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            return parts.join(".");
        },
        _lpad: function (s, padLength, padString) {
            var str = s + "";
        ...
        _formatString: function (val) {
            var options = this.options;
            var type = options.format;
            ...
            switch (true) {
                case "currency" == type:
                    returnString = this._numberWithCommas(val);
                    break;
                case "HH:00" == type:
                ...
                case /^HH(.*) mm(.*)$/.test(type) :
                    if (val.length == 4) {
                        ...
                        var dur = moment.duration(Number(val), "seconds");
                        var hours = Math.floor(dur.asHours());
                        var mins = Math.floor(dur.asMinutes()) - hours * 60;
                        returnString = hours + this._lpad(arr[1], 2, 0) + mins + this._lpad(arr[2], 2, 0);
                    }
                    break;
            }
        ...
        _handleEvents: {
            keydown: function (event) {
                var allowed, curVal, newVal, step,
                    index = $(event.target).data("bid__handle-index");
                ...
                switch (event.keyCode) {
                    ...
                    case $.ui.keyCode.LEFT:
                        ...
                        if (!this._keySliding) {
                            ...
                            this._addClass($(event.target), null, "bid--active");
                            allowed = this._start(event, index);
                            if (allowed === false) {
                                return;
                            }
                ...
                switch (event.keyCode) {
                    ...
                    case $.ui.keyCode.PAGE_DOWN:
                        newVal = this._trimAlignValue(
                            curVal - ((this._valueMax() - this._valueMin())
                            / this.numPages));
                        break;
                    case $.ui.keyCode.UP:
                    case $.ui.keyCode.RIGHT:
            ...
            keyup: function (event) {
                var index = $(event.target).data("bid__handle-index");

                if (this._keySliding) {
                    this._keySliding = false;
                    this._stop(event, index);
                    this._change(event, index);
                    this._removeClass($(event.target), null, "bid--active");
                }
            }
        }
    });
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _createHelper: function (event) {
            ...
            var o = this.options,
                ...
                helper = helperIsFunction ? $(o.helper.apply(this.element[0], [event])) : (o.helper === "clone"
            ...
            if (constrainPosition) {
                ...
                if (o.grid) {
                    ...
                    pageY = containment ? ((top - this.offset.click.top >= containment[1]
                        ||
                        top - this.offset.click.top > containment[3]) ? top : ((top - this.offset.click.top >= containment[1]) ? top
                        - o.grid[1] : top
                        + o.grid[1])) : top;
                    ...
                    pageX = containment ? ((left - this.offset.click.left
                        >= containment[0] ||
                        left - this.offset.click.left > containment[2]) ? left : ((left - this.offset.click.left >= containment[0]) ? left
                        - o.grid[0]
                        : left + o.grid[0])) : left;
                }
...
!function (a) {
    function f(a, b) {
        if (!(a.originalEvent.touches.length > 1)) {
            ...
            d.initMouseEvent(b, !0, !0, window, 1, c.screenX, c.screenY, c.clientX,
                c.clientY, !1, !1, !1, !1, 0, null), a.target.dispatchEvent(d)
        }
    }
    ...
    if (a.support.touch = "ontouchend" in document, a.support.touch) {
        ...
        b._touchStart = function (a) {
            ...
            && (e = !0, b._touchMoved = !1, f(a, "mouseover"), f(a, "mousemove"), f(a,
                "mousedown"))
        }, b._touchMove = function (a) {
            e && (this._touchMoved = !0, f(a, "mousemove"))
        }, b._touchEnd = function (a) {
            e && (f(a, "mouseup"), f(a, "mouseout"), this._touchMoved || f(a,
                "click"), e = !1)
